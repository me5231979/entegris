...
window.ENTG_CONTENT.de = {
  ui: {
    ...
    yourChoice: 'Ihre Entscheidung', chooseResponse: 'Wählen Sie eine Reaktion', pickClosest: 'Wählen Sie die Option, die Ihrem Verhalten am nächsten kommt.',
  ...
  home: {
    ...
    tagline: 'Bringen Sie Ihre Führung ein. Jeden Tag.',
  ...
  lessons: [
    {
      id: 'intro',
      title: 'Einführung in das Great Leader Profile (GLP) und seine Bedeutung heute',
      ...
      blocks: [
        ...
        { type: 'objectives', items: [
          'Verstehen, warum das Great Leader Profile die Führung bei Entegris leitet.',
          'Die Kernmerkmale und Verhaltensweisen erkennen, die großartige Führung in unserer Organisation ausmachen.',
          'Sehen, wie das GLP in Zeiten von organisatorischem Wachstum und Wandel für Konsistenz und Klarheit sorgt.',
          'Erkennen, dass Führung bei Entegris alle betrifft, nicht nur Personalverantwortliche.'
        ] },
        ...
        { type: 'accordion', items: [
          ...
          { title: 'GLP-Merkmale', html: '<p>Das GLP beschreibt sieben Kernmerkmale, die großartige Führung bei Entegris ausmachen:</p><ul><li>Baut Talente für die Zukunft auf</li><li>Fördert Partnerschaft in unserer globalen Organisation</li><li>Fördert Innovation</li><li>Führt mit Beharrlichkeit &amp; Bescheidenheit</li><li>Trifft datenbasierte Entscheidungen mit Tempo</li><li>Stellt den Kunden in den Mittelpunkt</li><li>Fördert Verbindlichkeit</li></ul>' },
        ...
        { type: 'characteristics', center: 'PACE', sub: 'Eine werteorientierte Kultur', items: [
          ...
          { icon: 'globe', name: 'Fördert Partnerschaft in unserer globalen Organisation', desc: 'Arbeitet wirksam über Teams und Regionen hinweg zusammen, um gemeinsame Ziele zu erreichen und unsere globale Wirkung zu stärken.' },
          ...
          { icon: 'shield', name: 'Fördert Verbindlichkeit', desc: 'Setzt klare Erwartungen, unterstützt die Umsetzung und sorgt dafür, dass Einzelne und Teams zu ihren Zusagen stehen.' },
          ...
          { icon: 'gauge', name: 'Trifft datenbasierte Entscheidungen mit Tempo', desc: 'Nutzt relevante Daten und Erkenntnisse, um zeitnah fundierte Entscheidungen zu treffen, die Ergebnisse bringen.' }
        ] },
        ...
        { type: 'quote', text: 'Jeder Tag bietet die Chance, mit Sinn zu führen und etwas Positives zu bewirken. Das GLP befähigt Sie, die Führungskraft zu werden, die Entegris braucht, unabhängig von Position oder Titel.' }
      ]
    },
    {
      id: 'collaboration',
      ...
      blocks: [
        { type: 'text', html: 'Druck zeigt, wie jemand führt. Wenn Zeitpläne enger werden oder Spannungen steigen, prägt Ihre Reaktion Vertrauen, Ausrichtung und Ergebnisse. In diesem Führungsmoment erkunden Sie, wie starke Führungskräfte unter Druck zusammenarbeiten, Klarheit bewahren, gemeinsame Verantwortung stärken und verhindern, dass Silos entstehen.' },
        { type: 'text', html: 'Überlegen Sie beim Durcharbeiten dieses Moduls, wie Sie auftreten, wenn es am meisten darauf ankommt.' },
        { type: 'download', name: 'Entegris Great Leader Profile & Playbook 2026.pptx', meta: 'PPTX · 761,8 KB', href: 'assets/docs/Entegris-Great-Leader-Profile-Playbook-2026.pptx' },
        { type: 'heading', text: 'Führungswachstum beginnt mit Zusammenarbeit unter Druck' },
        { type: 'text', html: 'Zusammenarbeit wird erst dann wirklich auf die Probe gestellt, wenn der Druck steigt. In Situationen mit hohem Einsatz müssen Führungskräfte Dringlichkeit und Ausrichtung in Einklang bringen und Menschen zusammenbringen, statt Silos oder Schuldzuweisungen zuzulassen. Wie Sie in diesen Momenten reagieren, prägt Vertrauen, Leistung und Kultur.' },
    ...
    },
    {
      ...
      blocks: [
        { type: 'text', html: 'Delegieren bedeutet nicht nur, Arbeit zu verteilen, sondern das richtige Maß an Befugnis zu übertragen. In diesem Führungsmoment untersuchen Sie das Spannungsfeld zwischen Eingebundenbleiben und echtem Zurücktreten. Wirksame Führungskräfte lassen bewusst los. Sie schaffen Raum, damit andere führen, Entscheidungen treffen und Glaubwürdigkeit aufbauen können, auch wenn viel auf dem Spiel steht. Loslassen auf der richtigen Ebene stärkt Vertrauen, entwickelt Fähigkeiten und festigt Verantwortung.' },
        ...
        { type: 'download', name: 'Entegris Great Leader Profile & Playbook 2026.pptx', meta: 'PPTX · 761,8 KB', href: 'assets/docs/Entegris-Great-Leader-Profile-Playbook-2026.pptx' },
        { type: 'heading', text: 'Führungswachstum geht weiter mit Loslassen auf der richtigen Ebene' },
        { type: 'text', html: 'Sehen Sie sich nun das Video an und achten Sie genau darauf, wie Befugnis im entscheidenden Moment entweder gestärkt oder zurückgeholt wird. Arbeiten Sie dabei mit Ihrem GLP Playbook und reflektieren Sie, wie Sie delegieren. Übertragen Sie echte Verantwortung oder bleiben Sie näher dran als nötig?' },
        ...
        { type: 'scenario', id: 'l3', prompt: 'Ein Stakeholder schlägt vor, dass Sie an Jessicas Meeting teilnehmen sollten. Was tun Sie?', options: [
          ...
          { key: 'b', title: 'Sicherheitshalber dabeisitzen', text: 'Still im Hintergrund teilnehmen und nur eingreifen, wenn etwas schiefläuft.', tag: 'Verantwortung verwässert', good: false, feedback: 'Ihre Anwesenheit verändert den Raum. Fragen wandern zu Ihnen, Jessica zweifelt an sich, und der Stakeholder lernt, an ihr vorbeizuschauen. Näher dran zu bleiben als nötig kostet sie trotzdem Glaubwürdigkeit.' },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'scenario', id: 'l4', prompt: 'Jessicas Team möchte vor der Stakeholder-Präsentation Ihren Input. Was tun Sie?', options: [
          { key: 'a', title: 'Wieder übernehmen', text: 'Das Meeting ist wichtig. Sie prüfen die Präsentation, nehmen Anpassungen vor und leiten die Stakeholder-Sitzung selbst.', tag: 'Holt die Verantwortung zurück', good: false, feedback: 'Die Übernahme sendet eine klare Botschaft: Wenn es darauf ankommt, ist das nicht eure Arbeit. Jessica hat monatelang geführt, und das Team verliert den sichtbaren Moment, den es sich verdient hat. Selbstvertrauen und Glaubwürdigkeit leiden.' },
          { key: 'b', title: 'Eine E-Mail schicken', text: 'Sie schreiben dem Team, dass Sie die Bedenken verstehen, ihm vertrauen und es präsentieren soll, was es für richtig hält.', tag: 'Lässt das Team allein', good: false, feedback: 'Eine vage Nachricht bietet einem Team, das um Unterstützung gebeten hat, weder Orientierung noch Coaching. Es weiß weiterhin nicht, was die Stakeholder erwarten, und die Anspannung vor einem sichtbaren Moment steigt.' },
          { key: 'c', title: 'Erst treffen und zuhören', text: 'Sie vereinbaren einen Termin mit dem Team. Bevor Sie Input geben, lassen Sie sich Positionierung und Vorgehen erklären.', tag: 'Stärkt die Verantwortung', good: true, feedback: 'Sie sind da, Sie coachen und widerstehen dem Impuls, unter Druck die Kontrolle zurückzunehmen. Jessica behält klare Verantwortung und echte Entscheidungsbefugnis. Das Team fühlt sich gestärkt und geht weiter voran.' }
        ] },
        { type: 'reflect', id: 'l4', title: 'Stärke ich mein Team wirklich?', intro: 'Empowerment wird nicht verkündet. Es wird vom Team erlebt. Nehmen Sie sich ein paar Minuten für diese Fragen.', questions: [
          ...
          { q: 'Wie könnte mein Verhalten in exponierten Momenten Empowerment stärken oder schwächen?', hint: 'Greifen Sie ein, wenn der Einsatz steigt? Beantworten Sie Fragen, die an Ihr Team gerichtet sind? Oder bleiben Sie im Hintergrund und lassen es führen?' },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'godo', id: 'l5', title: 'Ihre drei Go-Do-Aktionen', intro: 'Notieren Sie die drei Aktionen, die Sie in Ihrem nächsten Führungsmoment umsetzen werden. Sie werden mit Ihrem Kursfortschritt gespeichert.', labels: ['Go-Do-Aktion 1', 'Go-Do-Aktion 2', 'Go-Do-Aktion 3'], placeholders: ['In meinem nächsten Meeting unter Hochdruck werde ich…', 'Wenn ich das nächste Mal delegiere, werde ich…', 'Wenn ein Teammitglied führt, werde ich…'] },
