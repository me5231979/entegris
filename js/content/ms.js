...
window.ENTG_CONTENT.ms = {
  ui: {
    ...
    percentComplete: '{p}% selesai', complete: 'Selesai', inProgress: 'Sedang berjalan', notStarted: 'Belum dimulakan',
    ...
    yourChoice: 'Pilihan anda', chooseResponse: 'Pilih satu tindak balas', pickClosest: 'Pilih pilihan yang paling hampir dengan apa yang anda akan lakukan.',
  ...
  home: {
    ...
    intro: 'Bagaimana pemimpin hebat mengharungi pertumbuhan, perubahan dan ketidakpastian? Dalam kursus ini, anda akan mempelajari cara menerapkan Profil Pemimpin Hebat (GLP) yang diperbaharui dalam kepimpinan harian anda di Entegris. Melalui refleksi praktikal, senario dunia sebenar dan strategi yang boleh dilaksanakan, anda akan mengenal pasti kekuatan kepimpinan anda, membangunkan pendekatan baharu untuk memperkasa pasukan anda, dan belajar cara menyampaikan serta menjadi teladan GLP untuk impak yang berkekalan. Di akhir kursus, anda akan bersedia untuk memimpin diri sendiri dan orang lain dengan yakin, menjadikan GLP panduan hidup dalam perjalanan kepimpinan anda.',
    facts: [
      { k: 'Pelajaran', v: '5' },
  ...
  lessons: [
    {
      ...
      blocks: [
        ...
        { type: 'text', html: 'Objektif yang jelas membantu anda memfokuskan pembelajaran dan memahami bagaimana setiap bahagian pelajaran ini menyokong perkembangan anda sebagai pemimpin. Mengetahui apa yang akan anda capai membantu anda menghubungkan konsep GLP dengan pengalaman kepimpinan harian anda dengan lebih baik.' },
        { type: 'objectives', items: [
          ...
          'Hargai bahawa kepimpinan di Entegris adalah untuk semua orang, bukan hanya pengurus.'
        ] },
        ...
        { type: 'accordion', items: [
          { title: 'Tujuan GLP', html: '<p>Profil Pemimpin Hebat diwujudkan untuk mentakrifkan rupa kepimpinan hebat di Entegris dan menetapkan jangkaan yang jelas bagi semua pemimpin. Ia berfungsi sebagai panduan praktikal yang membantu pemimpin menyelaraskan tindakan mereka dengan strategi syarikat sambil membenarkan gaya kepimpinan yang tulen dan tersendiri.</p><p>Dengan memberikan kejelasan ini, GLP memperkasa pemimpin untuk membuat keputusan yang konsisten dan memupuk budaya positif berprestasi tinggi di seluruh organisasi.</p>' },
          { title: 'Evolusi GLP', html: '<p>Sejak diperkenalkan pada 2018, GLP telah berkembang seiring dengan Entegris. Apabila organisasi kita berkembang dan menghadapi cabaran baharu, kita menyedari keperluan untuk menyemak semula dan menyegarkan profil ini agar mencerminkan realiti semasa kita.</p><p>GLP yang dikemas kini kini merangkumi jangkaan dan tingkah laku baharu, memastikan ia kekal relevan dan berkesan sebagai panduan kepimpinan semasa tempoh perubahan dan pertumbuhan.</p>' },
          { title: 'Ciri-ciri GLP', html: '<p>GLP menggariskan tujuh ciri teras yang mentakrifkan kepimpinan hebat di Entegris:</p><ul><li>Membina Bakat untuk Masa Depan</li><li>Memacu Perkongsian Merentas Organisasi Global Kita</li><li>Memupuk Inovasi</li><li>Memimpin dengan Kecekalan &amp; Kerendahan Hati</li><li>Membuat Keputusan Berasaskan Data dengan Pantas</li><li>Memacu Keutamaan Pelanggan</li><li>Memacu Akauntabiliti</li></ul>' },
          { title: 'GLP untuk Semua Pemimpin', html: '<p>Kepimpinan di Entegris tidak terhad kepada pengurus sahaja. GLP terpakai kepada semua orang, tanpa mengira jawatan atau peranan. Ia tentang cara anda hadir, bekerjasama dan mengambil tanggungjawab dalam kerja harian anda.</p><p>Dengan menghayati GLP, setiap ahli pasukan boleh menyumbang kepada budaya kepimpinan kita dan memacu impak positif di seluruh organisasi.</p>' }
        ] },
        ...
        { type: 'text', html: 'Menyemak definisi setiap ciri GLP akan membantu anda menghayati rupa kepimpinan hebat di Entegris.' },
        ...
        { type: 'characteristics', center: 'PACE', sub: 'Budaya berpandukan nilai', items: [
          ...
          { icon: 'shield', name: 'Memacu Akauntabiliti', desc: 'Menetapkan jangkaan yang jelas, menyokong tindakan susulan, dan memastikan individu serta pasukan memiliki komitmen mereka.' },
          ...
          { icon: 'gauge', name: 'Membuat Keputusan Berasaskan Data dengan Pantas', desc: 'Menggunakan data dan pandangan yang relevan untuk membuat pilihan yang tepat pada masanya dan bermaklumat bagi memacu hasil.' }
        ] },
    ...
    },
    {
      ...
      blocks: [
        { type: 'text', html: 'Tekanan mendedahkan kepimpinan. Apabila garis masa semakin ketat atau ketegangan meningkat, tindak balas anda membentuk kepercayaan, penyelarasan dan hasil. Dalam Detik Kepimpinan ini, anda akan meneroka bagaimana pemimpin yang kukuh bekerjasama di bawah tekanan, mengekalkan kejelasan, memperkukuh pemilikan bersama, dan mencegah pembentukan silo.' },
        { type: 'text', html: 'Semasa anda melalui modul ini, renungkan bagaimana anda hadir apabila ia paling penting.' },
        { type: 'download', name: 'Entegris Great Leader Profile & Playbook 2026.pptx', meta: 'PPTX · 761.8 KB', href: 'assets/docs/Entegris-Great-Leader-Profile-Playbook-2026.pptx' },
        { type: 'heading', text: 'Pertumbuhan Kepimpinan Bermula dengan Kerjasama di Bawah Tekanan' },
        { type: 'text', html: 'Kerjasama benar-benar diuji apabila tekanan meningkat. Dalam situasi berisiko tinggi, pemimpin perlu mengimbangi kesegeraan dengan penyelarasan, menyatukan orang dan bukannya membiarkan silo atau salah-menyalahkan bertapak. Cara anda bertindak balas dalam detik-detik ini membentuk kepercayaan, prestasi dan budaya.' },
        ...
        { type: 'text', html: 'Kilang Materials Solutions menghadapi gangguan rantaian bekalan yang disebabkan oleh kerjasama yang lemah dan pasukan yang bersilo. Satu mesyuarat rentas fungsi dijadualkan untuk menangani isu-isu ini, tetapi seorang peserta utama, Peter, tidak dapat hadir. Tiga pilihan dipertimbangkan: menangguhkan mesyuarat, meneruskan dengan agenda penuh, atau melaraskan agenda untuk memfokuskan isu yang boleh diselesaikan. Pemimpin memilih untuk menyesuaikan mesyuarat, mengekalkan momentum dan memupuk kerjasama. Pemimpin yang berkesan menyesuaikan diri, memacu kemajuan, dan mewujudkan pemilikan bersama terhadap penyelesaian.' },
        { type: 'scenario', id: 'l2', prompt: 'Peter, seorang peserta utama, tidak dapat menghadiri mesyuarat rentas fungsi. Apa yang anda lakukan?', options: [
          { key: 'a', title: 'Tangguhkan mesyuarat', text: 'Tunggu sehingga Peter ada supaya setiap suara berada dalam bilik.', tag: 'Momentum hilang', good: false, feedback: 'Penangguhan menghantar isyarat bahawa kemajuan bergantung pada seorang individu. Isu rantaian bekalan terus merugikan kilang sementara pasukan terhenti, dan silo yang menyebabkan masalah itu kekal di tempatnya.' },
          { key: 'b', title: 'Teruskan dengan agenda penuh', text: 'Jalankan mesyuarat seperti yang dirancang dan bincangkan perkara Peter tanpa kehadirannya.', tag: 'Penyelarasan berisiko', good: false, feedback: 'Keputusan mengenai perkara Peter dibuat tanpa orang yang memilikinya. Ini mengundang kerja semula dan salah-menyalahkan kemudian, yang sebenarnya perkara yang cuba dielakkan oleh kerjasama di bawah tekanan.' },
          { key: 'c', title: 'Laraskan agenda', text: 'Fokus pada isu yang boleh diselesaikan oleh mereka yang hadir sekarang dan jadualkan perkara Peter bersamanya.', tag: 'Pemilikan bersama', good: true, feedback: 'Anda mengekalkan momentum, menghormati pemilikan Peter, dan memberi pasukan kemajuan sebenar untuk dibina. Menyesuaikan mesyuarat mengubah tekanan menjadi kerjasama dan bukannya silo.' }
        ] },
        { type: 'quote', text: 'Kerjasama sejati paling terserlah di bawah tekanan, di mana perpaduan mengubah cabaran menjadi peluang untuk berjaya.' }
      ]
    },
    {
      id: 'letting-go',
      ...
      blocks: [
        { type: 'text', html: 'Pengagihan tugas bukan sekadar memberikan kerja; ia tentang memindahkan tahap kuasa yang betul. Dalam detik kepimpinan ini, anda akan meneliti ketegangan antara kekal terlibat dan benar-benar berundur. Pemimpin yang berkesan melepaskan dengan niat. Mereka mewujudkan ruang untuk orang lain memimpin, membuat keputusan, dan membina kredibiliti walaupun ketika risikonya tinggi. Melepaskan pada tahap yang betul mengukuhkan kepercayaan, membangunkan keupayaan, dan memperkukuh pemilikan.' },
        { type: 'text', html: 'Semasa anda melalui bahagian ini, fikirkan: Adakah anda mengagihkan tugas atau memperkasa kepimpinan?' },
        { type: 'download', name: 'Entegris Great Leader Profile & Playbook 2026.pptx', meta: 'PPTX · 761.8 KB', href: 'assets/docs/Entegris-Great-Leader-Profile-Playbook-2026.pptx' },
        { type: 'heading', text: 'Pertumbuhan Kepimpinan Berterusan dengan Melepaskan pada Tahap yang Betul' },
        { type: 'text', html: 'Sekarang, tonton video dan beri perhatian kepada bagaimana kuasa sama ada diperkukuh atau diambil semula pada detik itu. Semasa menonton, rujuk Buku Panduan GLP anda dan renungkan cara anda mengagihkan tugas. Adakah anda memindahkan pemilikan sebenar, atau kekal lebih dekat daripada yang perlu?' },
        ...
        { type: 'text', html: 'Seorang pemimpin kilang mengagihkan satu inisiatif utama kepada Jessica, seorang ahli pasukan berprestasi tinggi. Apabila pihak berkepentingan mencadangkan agar pemimpin itu menghadiri mesyuarat, mereka perlu memutuskan sama ada untuk mengambil semula kawalan atau memperkasa Jessica sepenuhnya. Memilih untuk membiarkan Jessica memimpin secara berdikari menunjukkan kepercayaan, membina kredibilitinya, dan menyokong perkembangannya sebagai pemimpin.' },
        { type: 'scenario', id: 'l3', prompt: 'Pihak berkepentingan mencadangkan anda menghadiri mesyuarat Jessica. Apa yang anda lakukan?', options: [
          ...
          { key: 'b', title: 'Duduk sahaja, sekadar berjaga-jaga', text: 'Hadir secara senyap di belakang dan masuk campur hanya jika keadaan tidak terkawal.', tag: 'Pemilikan tercair', good: false, feedback: 'Kehadiran anda mengubah suasana. Soalan beralih kepada anda, Jessica meragui dirinya sendiri, dan pihak berkepentingan belajar untuk memandang melepasinya. Kekal lebih dekat daripada yang perlu tetap menjejaskan kredibilitinya.' },
        ...
        { type: 'quote', text: 'Kepimpinan sejati adalah tentang mengetahui bila untuk melepaskan; memperkasa orang lain pada tahap yang betul memupuk kepercayaan, pertumbuhan dan kejayaan bersama.' }
      ]
    },
    {
      id: 'reinforce',
      ...
      blocks: [
        { type: 'text', html: 'Memperkukuh kepercayaan dan mengambil semula fokus adalah kemahiran kepimpinan yang penting. Pemimpin yang berkesan memahami bila untuk berundur bagi memperkasa pasukan mereka dan bila untuk masuk campur bagi menyelaraskan semula keutamaan. Dengan memperkukuh kepercayaan, anda mewujudkan persekitaran di mana orang lain berasa yakin untuk mengambil pemilikan dan membuat keputusan. Mengambil semula fokus memastikan pasukan kekal selaras dengan matlamat menyeluruh, walaupun dalam detik yang mencabar. Mengimbangi tindakan ini mengukuhkan kerjasama dan memacu kejayaan.' },
        { type: 'download', name: 'Entegris Great Leader Profile & Playbook 2026.pptx', meta: 'PPTX · 761.8 KB', href: 'assets/docs/Entegris-Great-Leader-Profile-Playbook-2026.pptx' },
        { type: 'heading', text: 'Perkukuh atau Ambil Semula?' },
        { type: 'text', html: 'Dalam detik kepimpinan ini, anda akan meneroka satu ketegangan yang lazim: apabila seorang ahli pasukan sedang memimpin, adakah anda masuk campur, atau kekal menyokong di belakang mereka? Detik-detik ini sering berlaku dengan pantas dan di bawah tekanan. Tindak balas anda boleh sama ada memperkukuh pemilikan dan kredibiliti atau tanpa disengajakan mengambil semula kuasa.' },
        { type: 'text', html: 'Semasa menonton video, beri perhatian kepada isyarat yang dihantar, bukan hanya melalui kata-kata, tetapi melalui kehadiran dan tindakan.' },
        ...
        { type: 'scenario', id: 'l4', prompt: 'Pasukan Jessica mahukan input anda sebelum pembentangan kepada pihak berkepentingan. Apa yang anda lakukan?', options: [
          { key: 'a', title: 'Ambil alih semula', text: 'Mesyuarat ini penting. Anda menyemak pembentangan, membuat pelarasan dan mengetuai sendiri sesi dengan pihak berkepentingan.', tag: 'Mengambil semula pemilikan', good: false, feedback: 'Mengambil alih menghantar mesej yang jelas: apabila ia penting, ini bukan kerja anda. Jessica memimpin selama berbulan-bulan, dan pasukan kehilangan detik penting yang mereka layak dapat. Keyakinan dan kredibiliti terjejas.' },
          { key: 'b', title: 'Hantar e-mel', text: 'Anda memberitahu pasukan bahawa anda memahami kebimbangan mereka, anda mempercayai mereka, dan mereka patut membentangkan apa yang mereka yakini betul.', tag: 'Membiarkan pasukan sendirian', good: false, feedback: 'Mesej yang kabur tidak memberi panduan atau bimbingan kepada pasukan yang meminta sokongan. Mereka masih tidak pasti apa yang diharapkan pihak berkepentingan, dan kebimbangan mereka meningkat sebelum detik yang sangat diperhatikan.' },
          { key: 'c', title: 'Bertemu dan dengar dahulu', text: 'Anda menjadualkan masa dengan pasukan. Sebelum memberi input, anda meminta mereka menerangkan kedudukan dan pendekatan mereka.', tag: 'Memperkukuh pemilikan', good: true, feedback: 'Anda hadir, anda membimbing, dan anda menahan diri daripada mengambil alih kawalan apabila tekanan meningkat. Jessica mengekalkan pemilikan yang jelas dan kuasa membuat keputusan yang sebenar. Pasukan berasa diperkasa untuk terus maju.' }
        ] },
        { type: 'reflect', id: 'l4', title: 'Adakah saya benar-benar memperkasa pasukan saya?', intro: 'Pemerkasaan bukan sesuatu yang kita isytiharkan. Ia sesuatu yang dialami pasukan kita. Luangkan beberapa minit untuk soalan-soalan ini.', questions: [
          { q: 'Bagaimana kerja akan diteruskan jika saya tidak ada?', hint: 'Jika kemajuan perlahan, keputusan tergendala, atau pihak berkepentingan menunggu anda, itu satu isyarat.' },
          { q: 'Bagaimana tingkah laku saya dalam detik yang diperhatikan mungkin memperkukuh atau melemahkan pemerkasaan?', hint: 'Adakah anda masuk campur apabila risiko meningkat? Menjawab soalan yang ditujukan kepada pasukan anda? Atau kekal di belakang mereka dan biarkan mereka memimpin?' },
          { q: 'Bagaimana pasukan saya boleh beroperasi dengan lebih berdikari enam bulan dari sekarang jika saya lebih memperkasa mereka hari ini?', hint: 'Adakah mereka mencadangkan penyelesaian dan bukan sekadar melaporkan masalah? Menguasai perbualan dengan pihak berkepentingan? Berkembang dalam pertimbangan?' }
        ] },
    ...
    },
    {
      ...
      blocks: [
        { type: 'text', html: 'Merentasi detik-detik kepimpinan ini, satu tema menonjol: kepimpinan ditentukan dalam masa nyata. Sering kali singkat. Kadangkala tidak selesa. Sentiasa memberi kesan. Sama ada bekerjasama di bawah tekanan, memperkukuh atau mengambil semula kuasa, atau melepaskan pada tahap yang betul, tindak balas anda menghantar isyarat: isyarat tentang kepercayaan, pemilikan, malah tentang rupa kepimpinan dalam tindakan. Pemimpin hebat bertindak dengan niat. Mereka memperkukuh kredibiliti, memindahkan kuasa sebenar, dan menyatukan orang, terutamanya apabila risikonya tinggi. Ketika anda melangkah ke hadapan, berhenti sejenak dalam detik kepimpinan anda sendiri. Tanya diri anda: “Apakah isyarat yang saya hantar sekarang?”' },
        { type: 'heading', text: 'Mari Kita Semak' },
        { type: 'text', html: 'Dalam video ini, kita akan beralih daripada pemahaman kepada tindakan. Detik kepimpinan hanya memberi impak apabila anda menerapkan apa yang telah anda pelajari. Tiga Tindakan Segera direka untuk membantu anda menterjemahkan refleksi kepada tingkah laku sebenar, langkah mudah dan bersengaja yang boleh anda ambil dengan segera.' },
